...
<div class="body_left">
        ...
        <div class="body_left_list">
            <ul>
                ...
                <br>
                <li>
                    <a href="DoctorMessage.php" target="iframe_nurse">个人信息</a>
                </li>
                <br>
                <li>
                    <a href="NurseLeaderManager.php" target="iframe_nurse">护士长管理</a>
                </li>
                <br>
                <li>
                    <a href="HouseNurseManager.php" target="iframe_nurse">病房护士管理</a>
                </li>
                <br>
                <li>
