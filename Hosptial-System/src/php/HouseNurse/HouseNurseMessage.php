...
<table style="border: 1px;margin: 0 auto;background:oldlace" width="40%" cellpadding="5" cellspacing="0" >
    ...
    <tr>
        <td>工号</td>
        <td><input type="text" name="nurseId" style="width:90%"readonly="readonly" value="<?php echo $arr["nurseId"] ?>"></td>
    </tr>
    <tr>
        <td >性别</td>
    ...
    <tr>
        <td >最多负责人数</td>
        <td><input type="text" name="max" style="width:90%" readonly="readonly"value="<?php echo $arr["max"] ?>"></td>
    </tr>
    <tr>
        <td >负责病人数</td>
        <td><input type="text" name="number" style="width:90%" readonly="readonly"value="<?php echo $arr["number"] ?>"></td>
    </tr>
    <tr>
        <td colspan="4" align="center">

            <a href='editHouseNurse.php?id={$arr[' nuresId']}'>修改</a>
        </td>
    </tr>
