...
<table style="border: 1px;margin: 0 auto;background: snow" width="40%" cellpadding="5" cellspacing="0" >
    <form action="action_PatientCase1.php" method="post" enctype="multipart/form-data">
        <tr>
            <td>姓名</td>
        ...
        <tr>
            <td >评级</td>
            <td><input type="text" name = "level" style="width:90%" value="<?php echo $arr["level"] ?>"></td>
        </tr>
        ...
        <tr>
            <td>病床</td>
            <td><input type="text"readonly = "readonly" name = "bed" style="width:90%"value="<?php echo $arr["bed"] ?>"></td>

        </tr>
        <tr>
            <td>负责护士</td>
            <td><input type="text" readonly = "readonly" name = "housenurse" style="width:90%"value="<?php echo $arr["housenurse"] ?>"></td>
        </tr>
            <tr>
                <td >生命状态</td>
