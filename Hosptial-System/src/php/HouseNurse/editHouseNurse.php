...
$sql = "SELECT nurseId, name, sex,age,position,area,max,number FROM HouseNurse WHERE nurseId = '22'";
...
<table style="border: 1px;margin: 0 auto;background:oldlace" width="40%" cellpadding="5" cellspacing="0" >
    <form action="action_editHouseNurse.php" method="post" enctype="multipart/form-data">
        <tr>
            <td>姓名</td>
        ...
        <tr>
            <td>工号</td>
            <td><input type="text" name="nurseId" style="width:90%" value="<?php echo $arr["nurseId"] ?>"></td>
        </tr>
        <tr>
            <td >性别</td>
        ...
        <tr>
            <td >最多负责人数</td>
            <td><input type="text" name = "max" style="width:90%" value="<?php echo $arr["max"] ?>"></td>
        </tr>
        <tr>
            <td >负责病人数</td>
            <td><input type="text" name = "number" style="width:90%" value="<?php echo $arr["number"] ?>"></td>
        </tr>
        <tr>
