...
<div class="body_left">
        ...
        <div class="body_left_list">
            <ul>
                ...
                <br>
                <li>
                    <a href="EmergencyNurseMessage.php" target="iframe_nurse">个人信息</a>
                </li>
                <br>
                <li>
                    <a href="addtPatient.php" target="iframe_nurse">导入病人</a>
                </li>
                <br>
                <li>
                    <a href="EmergencyNurseCheckPatient.php" target="iframe_nurse">查看病人</a>
                </li>
                <br>
                <li>
